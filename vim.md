...
>Important: 所有的編輯指令，都必須在英文輸入法下才能作用。另外，vim指令區分大小寫。
...
新手想入門vim，可以跳至文章最後 [**補充:快速入門**](#補充-快速入門)。
...
指令|用途
---|---
:e [file]|開起file(tab可補全)，不存在則新增
:e [path]/[file]|開啟path下的file
...
>Note: vim區分大小寫，有時指令出錯是因為按到大寫，或在中文模式。
